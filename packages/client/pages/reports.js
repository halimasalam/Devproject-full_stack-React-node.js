...
import AverageCaloriesTable from "../features/Reports/AverageCaloriesTable";
...
export default function CalorieLimits({ recentFoodCount }) {
  ...
  return (
    <div>
      <Head>
        <title>Calorie Tracker | Reports</title>
        <meta name="description" content="Calorie app - reports page" />
