...
import FoodEntriesTable from "../features/FoodEntries/FoodEntriesTable";
import TopCards from "../features/Reports/TopCards";
import { useSelector } from "react-redux";
import { useEffect } from "react";

export default function Dashboard({ recentFoodCount, fetchRecentFoodCount }) {
  ...
  return (
    <div>
      <Head>
        ...
        <meta name="description" content="Calorie app dashboard" />
